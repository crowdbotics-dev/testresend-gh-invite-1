...
## Project Structure
    ...
    ├── testresend_gh_invite_1  # Django project configurations
...
1. Clone this repo and `cd testresend_gh_invite_1`
...
2. Clone this repo and `cd testresend_gh_invite_1`
